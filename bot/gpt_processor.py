...
7. Обращай внимание только на сообщения, содержащие явные триггерные фразы типа "надо сделать", "нужно сделать", "требуется", "задача", "запрос", "разработать", "создать", "добавить", "исправить", "изменить"
8. Игнорируй общие разговоры, вопросы без конкретных требований, комментарии и обсуждения
